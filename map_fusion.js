...
var MapsLib = {
  ...
  map_centroid:       new google.maps.LatLng(59.329323, 18.068581), //center that your map defaults to
  ...
  initialize: function() {
    ...
    map = new google.maps.Map($("#map_canvas")[0],myOptions); // map_canvas is the id of the map div
